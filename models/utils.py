...
MODEL_NAME_TO_PREFIX_TYPE = {
    ...
    "SFR-Embedding-Mistral": "instruction",
}
...
def get_task_def_by_task_name_and_type(task_name: str, task_type: str) -> str:
    ...
    if task_type in ['Retrieval']:
        ...
        # NUM_DOCS_ABLATIONS = [2, 5, 10, 50, 100, 500]
        # for key in task_name_to_instruct:
        #     lowercase = key.lower()
        #     for num in NUM_DOCS_ABLATIONS:
        #         for w_correct in [True, False]:
        #             with_correct_str = "_w_correct" if w_correct else ""
        #             task_name_to_instruct[f"{lowercase}_top_{num}_only{with_correct_str}"] = task_name_to_instruct[key]
